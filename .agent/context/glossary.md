...
> Defines domain-specific terms so the agent uses consistent language.

| Term          | Definition                                          |
|---------------|-----------------------------------------------------|
| TUI           | Terminal User Interface — a text-based UI in the terminal |
| Jira          | Atlassian's issue tracking / project management tool |
